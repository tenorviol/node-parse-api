...
Parse.prototype = {
    ...
    findMany: function (className, query, order, limit, skip, callback) {
        ...
        // if only 5 arguments exist, fifth argument is the callback, skip is undefined
        ...
        if (typeof(query) === 'string') {
            ...
            parseRequest.call(this, 'GET', '/1/classes/' + className, { limit: limit, order:order, skip:skip, where: JSON.stringify(query) }, callback);
        } else {
